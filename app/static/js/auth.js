async function regFunction(event) {
    ...
    try {
        ...
        if (result.message) {  // Проверяем наличие сообщения о успешной регистрации
            window.location.href = '/pages/auth';  // Перенаправляем пользователя на страницу логина
        } else {
...
async function loginFunction(event) {
    ...
    try {
        ...
        window.location.href = '/pages/profile'; // проверить почему дальше в блоке возникает ошибка при логине
